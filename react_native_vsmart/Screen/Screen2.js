    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
            ...
            <View style={{ flex: 1, backgroundColor: '#dfe3e3', marginTop: 20 }}>
                ...
                <TouchableOpacity onPressIn={onPress1} activeOpacity={0.5} style={{ alignSelf: 'center', width: 100, height: 10, backgroundColor: 'silver', marginTop: 20 }}></TouchableOpacity>
                <TouchableOpacity onPressIn={onPress2} activeOpacity={0.5} style={{ alignSelf: 'center', width: 100, height: 10, backgroundColor: 'red', marginTop: 10 }}></TouchableOpacity>
                <TouchableOpacity onPressIn={onPress3} activeOpacity={0.5} style={{ alignSelf: 'center', width: 100, height: 10, backgroundColor: 'black', marginTop: 10 }}></TouchableOpacity>
                <TouchableOpacity onPressIn={onPress4} activeOpacity={0.5} style={{ alignSelf: 'center', width: 100, height: 10, backgroundColor: 'blue', marginTop: 10 }}></TouchableOpacity>
